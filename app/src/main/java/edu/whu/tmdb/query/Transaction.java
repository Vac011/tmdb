...
//        classtab.delete();
        File objtab=new File(App.context.getCacheDir(),"/data/data/edu.whu.tmdb/transaction/objecttable");
        objtab.delete();
    }
...
//        this.SaveAll();
    ...
    public void insertIntoTrajTable() {
        TorchConnect torchConnect = new TorchConnect(memConnect,"Torch_Porto_test");
        String DIR =new File(App.context.getCacheDir(),"data/res/raw/porto_raw_trajectory.txt").getAbsolutePath();
        torchConnect.insert(DIR);
    }
